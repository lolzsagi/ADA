...
int main()
{
	 int arr[99][99],arr2[99][99],x=1,value,flag=0,magic[99],size,countj,countk,countl,ra=1,sum=0;
	int st;
			...
			counti--;
				...
				while(ra!=0)
				{
					...
					{	 
						...
						if(arr1[ra][x]arr2[ra2][x],arr1[ra][x+1]arr2[ra2][x+1],arr1[ra][x+2]arr2[ra2][x+2],arr2[ra][x+3]arr1[ra2][x+3],arr1[ra][x+4]arr1[ra][x+4],arr1[ra][x+5]arr1[ra][x+5])
						{
						ra2=ra1;
